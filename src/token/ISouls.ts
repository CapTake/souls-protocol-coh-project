...
export interface ISoulsInterface extends utils.Interface {
  functions: {
    ...
    "soul(uint256)": FunctionFragment;
    "summon(address,uint256,(uint8,uint8,uint8,uint8,uint8,uint8,uint8,uint8))": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "soul",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "summon",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>, KokoroStruct]
  ): string;
  encodeFunctionData(
...
export interface ISouls extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISoulsInterface;
